...
// Star: shifted +4.5% in y from a top-anchored star so the bounding box (was y 0–91)
// is centered in the 0–100 box — its x/y placement is the shape CENTER, so the shape
// must sit centered (otherwise a starburst reads as floating high in every preview/frame).
