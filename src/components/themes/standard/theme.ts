...
// Display headlines in sentence case, warm-gray Inter paragraphs, taupe uppercase labels, and a
...
//   frame.css        the `.block-frame` base (frame ground, body wrapper, h3, the bare taupe
...
//     standard has no saturated colour at all. Its "accent" is a stone taupe, and its emphasis
...
//     vocabulary, and the Line taupe that draws it is its own palette role.
...
// properties below. It de-dupes to the reference's own seven: Taupe, Line, Sandstone, Stone, Gray,
// White, Ink.
//
// THE FOUR ACCENT-CYCLE SLOTS ARE ALL THE ONE TAUPE. ACCENT_CYCLE walks
...
// all resolve to taupe with no `!important` anywhere. It is the same device professional uses for
...
// matters here more than in any other theme, because the Line taupe is a BORDER colour — light
...
const palette: NonNullable<ThemeTokens["palette"]> = [
  ...
  { name: "Taupe", hex: "#8A8178", varName: "secondary" },
  { name: "Taupe", hex: "#8A8178", varName: "accent-1" },
  { name: "Taupe", hex: "#8A8178", varName: "accent-2" },
  {
    name: "Line",
    hex: "#B8B0A4",
...
// Inter/gray for what explains, Inter/taupe for what labels. Colour never carries emphasis.
const typography: ThemeTokens["typography"] = [
  ...
  {
    token: "label",
    spec: "Inter 500 · uppercase · 0.22em · taupe — every eyebrow, stat label, column head and counter; no chip, no fill",
...
const rules: ThemeTokens["rules"] = {
  do: [
    "Use ONE hairline — 0.125rem in the Line taupe — for every border, rule, track and ring. The hairline is the identity.",
    "Set every Playfair Display headline in sentence case, in ink, at 600 (700 for the cover and the closing statement).",
    "Render labels in taupe Inter, uppercase, tracked 0.22em — no chip, no fill, no border.",
  ...
  dont: [
    ...
    "No bold Playfair Display, no taupe headlines, no thick borders.",
...
const examples: NonNullable<ThemeTokens["examples"]> = {
  ...
  "closing-plate": {
    params: { headline: "Well framed, on stone.", cta: "Begin the conversation" },
  },
  "feature-cards": {
    ...
    children: [
      {
        title: "Hairline",
        body: "One taupe rule carries every border in the deck.",
        icon: "I",
        accent: "primary",
      },
      {
  ...
  chart: {
    params: { headline: "By quarter", caption: "Measured across the programme." },
    children: [
...
export const standardTheme: ThemeTokens = {
  ...
  title: "Standard",
  description:
    "A quiet museum-catalog theme on warm stone. Playfair Display headlines against Inter body copy, taupe uppercase labels, and a single hairline carrying every border and compass ring. No colour, no shadows. Frame unit: 1920×1080, 16:9.",
  css: tokensCss,
  frameCss,
  ...
  // re-tinted for standard in frame.css (the ruled designs onto the Line taupe), so a scene that
